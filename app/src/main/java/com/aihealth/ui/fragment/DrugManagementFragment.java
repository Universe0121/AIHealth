...
import com.aihealth.ui.adapter.DrugAdapter;
import com.aihealth.ui.adapter.MultiTimeAdapter;
...
public class DrugManagementFragment extends Fragment {
    ...
    private void showMultiTimePickerDialog(int targetTimes) {
        ...
        MultiTimeAdapter timeAdapter = new MultiTimeAdapter(takeTimeList, (cal, position) -> showTimePickerDialog(cal, position));
