...
public class SimpleBarChart extends View {
    ...
    private int normalColor = Color.parseColor("#2E7D32"); // 正常范围：绿色
    private int warningColor = Color.parseColor("#F9A825"); // 警告范围：橙色
    private int dangerColor = Color.parseColor("#C62828"); // 危险范围：红色
