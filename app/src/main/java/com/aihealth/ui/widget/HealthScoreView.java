package com.aihealth.ui.widget;
...
public class HealthScoreView extends View {
    ...
    // 评分等级颜色
    private int excellentColor = Color.parseColor("#2E7D32"); // 优秀：90-100
    private int goodColor = Color.parseColor("#66BB6A");      // 良好：80-89
    private int mediumColor = Color.parseColor("#F9A825");    // 中等：70-79
    private int poorColor = Color.parseColor("#FB8C00");      // 较差：60-69
    private int badColor = Color.parseColor("#C62828");       // 差：0-59
    ...
    private void init() {
        textColor = ContextCompat.getColor(getContext(), R.color.on_surface);
        secondaryTextColor = ContextCompat.getColor(getContext(), R.color.on_surface_variant);
        trackColor = ContextCompat.getColor(getContext(), R.color.outline_variant);
