...
public class SimpleLineChart extends View {
    ...
    private int lineColor = Color.parseColor("#00696B"); // 医疗蓝
    private int pointColor = Color.parseColor("#FB8C00"); // 强调色
    // 主题感知颜色
    ...
    private void init() {
        ...
        gridColor = ContextCompat.getColor(getContext(), R.color.outline_variant);
    ...
    private void drawYAxisLabels(Canvas canvas, int left, int top, int height) {
        ...
        yLabelPaint.setColor(textColor);
    ...
    private void drawXAxisLabels(Canvas canvas, int left, int top, int width, int height, int bottomMargin) {
        ...
        xLabelPaint.setColor(textColor);
    ...
    private void drawDataPoints(Canvas canvas, int left, int top, int width, int height) {
        ...
        fillPaint.setColor(ContextCompat.getColor(getContext(), R.color.primary_light)); // 浅蓝色填充
